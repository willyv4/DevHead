		...
		>
			...
			{users &&
				users?.map((user: UserData) => (
					<div
						key={user.id}
						className="bg-gray-950/20 border-2 border-white/5 col-span-1 flex flex-col rounded-md text-center shadow"
					>
			...
			<div
				className="fixed inset-x-0 -z-10 transform-gpu overflow-hidden blur-3xl top-80"
				aria-hidden="true"
			>
				<div
					...
					style={{
						clipPath:
							"polygon(74.1% 44.1%, 300% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 300.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
					}}
				/>
			</div>
		</div>
